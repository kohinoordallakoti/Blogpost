...
const BlogDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-amber-50 py-16">
        <div>
            <button onClick={() => navigate(-1)} className="ml-10 mb-6 text-amber-700 hover:text-amber-900 font-semibold"> &larr; Back to Blogs</button>
        </div>
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <img
          ...
          alt={blog.title}
          className="w-100 h-150 object-fill"
        />
        </div>
