    ...
    <header className="bg-amber-600 text-white relative">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between h-20">
        ...
        <nav className="hidden md:flex gap-6 text-lg font-medium">
          ...
          <Link className="hover:text-amber-200" to="/blog">Blog</Link>
          <Link className="hover:text-amber-200" to="/about">About</Link>
          <Link className="hover:text-amber-200" to="/contact">Contact</Link>
        </nav>
        ...
        <div className="flex items-center gap-3 relative">
          ...
          {user ? (
            <div className="relative flex gap-10 ">
                <div>
              <Link className="hover:text-amber-200 p-0" to="/likedblogs">Liked Blogs</Link>
              </div>
              <button
